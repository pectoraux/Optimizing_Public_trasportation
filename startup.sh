...
psql -d classroom -c "COPY purchases(id,username,currency,amount)  FROM '/home/workspace/purchases.csv' DELIMITER ',' CSV HEADER;"
psql -d classroom -c "COPY clicks(id,email,timestamp,uri,number)  FROM '/home/workspace/clicks.csv' DELIMITER ',' CSV HEADER;"
...
psql -d cta -c "COPY stations(stop_id, direction_id,stop_name,station_name,station_descriptive_name,station_id,\"order\",red,blue,green) FROM '/home/workspace/cta_stations.csv' DELIMITER ',' CSV HEADER;"
...
kafka-topics --delete --zookeeper localhost:2181 --topic com.udacity.streams.pages
kafka-topics --delete --zookeeper localhost:2181 --topic com.udacity.streams.clickevents
kafka-topics --create --zookeeper localhost:2181 --topic com.udacity.streams.pages --replication-factor 1 --partitions 10
kafka-topics --create --zookeeper localhost:2181 --topic com.udacity.streams.clickevents --replication-factor 1 --partitions 10
